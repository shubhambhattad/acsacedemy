        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          ...
          <Link 
            ...
            className={cn(
              ...
              "mb-6 rounded-lg gap-1 flex items-center w-fit"
            )}
          >
          ...
          <article className="space-y-6">
            ...
            {/* Author / Date info */}
            <div className="flex flex-wrap items-center gap-4 text-xs font-semibold text-muted-foreground border-y border-border/60 py-3">
            ...
            {/* Excerpt */}
            <div className="p-4 bg-muted/40 rounded-xl border border-border/60 text-xs sm:text-sm font-semibold italic text-muted-foreground leading-relaxed">
              {post.excerpt}
            </div>
          ...
          <div className="mt-16 pt-10 border-t border-border/60 space-y-6">
              ...
              {relatedPosts.map((rPost) => (
                ...
                >
                  <CardContent className="p-5 space-y-3">
                    <span className="text-[10px] font-bold uppercase text-primary bg-primary/10 px-2 py-0.5 rounded w-fit">
                      {rPost.category}
                    </span>
          ...
          {/* Counselling Banner */}
          <Card className="mt-16 border border-primary/20 bg-gradient-to-r from-primary/5 to-secondary/5 p-8 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <Link 
              ...
              className={cn(
                ...
                "bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-lg shrink-0 flex items-center justify-center"
              )}
            >
